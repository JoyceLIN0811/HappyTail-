...
<nav class="navbar navbar-expand-lg navbar-light bg-white">
	<a class="navbar-brand" href="<c:url value='/HappyTailIndex.jsp'/>" style="display: block; margin: auto;">
		<img src="<c:url value='/img/logo210_1905.png'/>" width="210" height="210" style="display: block;margin-left: 110px">
	</a>
	...
	<c:if test="${ !empty LoginOK}">
		...
		<li>
			<a data-toggle="tab" href="#">
				<i class='fas fa-bell' style='font-size: 24px; color: rgba(0, 0, 0, 0.54); padding: 10px; margin-bottom: 170px;'></i>
			</a>
		</li>
		<li><a class="right sidenav-trigger show-on-medium-and-up" data-target="side-nav" href="#">
				<i class="fa fa-align-justify" style="font-size: 24px; color: rgba(0, 0, 0, 0.54); padding: 10px; margin-bottom: 170px;" onclick="openNav()"></i> 
			</a>
		</li>
	</ul>
</nav>
		...
		<ul class="navbar-nav">
			...
			<li class="nav-item dropdown"><a
				...
				<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
					...
					<a class='dropdown-item' href="<c:url value='pageBackView?pageNum=1' />">Reservation back</a> 
...
<div id="mySidenav" class="sidenav">
	...
	<span style="color: white; font-family: fantasy; font-size: 18px;"><img
		src="<c:url value='/img/logo_white3.png'/>">Happy Tail</span> 
		<a href="#home">Home</a>
