		...
		<div class="row">
			...
			<div class="col-sm-10">
				<blockquote class="blockquote" style="margin-top: 60px;">
					<p class="mb-0">
						總文章數量：
						<c:out value="${topiclist.totalCount}" default="0"></c:out>
					</p>
				</blockquote>
						...
						<li class="nav-item dropdown"><a
							...
							<div class="dropdown-menu">
								<a class="dropdown-item"
									href="<c:url value='/forum/topiclist?tagType=hit'/>">熱門</a>
								<div class="dropdown-divider"></div>
								<a class="dropdown-item"
									href="<c:url value='/forum/topiclist?tagType=createDate'/>">最新</a>
							</div></li>
					</ul>
				</div>
				...
				<div class="card bg-dark text-white" style="max-width: 100%;">
					<div class=" card-body">
						<div class="row justify-content-around">
							...
							<div class="col-md-2">
								<img src="img/story2.png" class="card-img" alt="...">
							</div>
							<div class="col-md-2">
								<img src="img/story2.png" class="card-img" alt="...">
							</div>
							...
							<c:forEach varStatus="star" var="aTopicBean"
								...
								<div class="card-body">
									<div class="row no-gutters">
										...
										<div class="col-md-4">
											<p class="card-text">
												<img src="<c:url value='/img/foot.png'/>" class="card-img"
													alt="..." style="height: 30px; width: 40px;"> <span>${aTopicBean.username}</span>
											</p>
										</div>
									...
									<div class="row no-gutters">
										<div class="col-md-10">
											...
											<div class="row no-gutters">
												...
												<div class="col-md-3">
													<i class="far fa-hand-point-up"></i><span class="card-text">${aTopicBean.count}</span>
												</div>
												<div class="col-md-3">
